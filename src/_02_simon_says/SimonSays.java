...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		JOptionPane.showMessageDialog(null, "If you see simon says, press the matching key.  If you don't, press any other key.");
	...
	public void keyPressed(KeyEvent e) {
		...
		if (simonSays = true && hashCode() == imageIndex) {
		...
		// say..."
		else if (simonSays = false && hashCode() != imageIndex) {
